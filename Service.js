...
import bgImage from "../images/1.png"; // Change image if needed
import $ from "jquery";
...
export default function Services() {
  ...
  const handleViewClick = () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        const section = document.getElementById("serviceExpandedSection");
        if (section) {
...
<button
  ...
  className="absolute bottom-8 z-20 flex flex-col items-center text-purple-950 opacity-80 hover:opacity-100 transition duration-300"
  title="Scroll down"
>
  <svg
